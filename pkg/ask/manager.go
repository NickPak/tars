...
// Manager 管理所有 in-flight 询问/审批的答复通道。
type Manager struct {
	mu      sync.Mutex
...
func NewManager() *Manager {
	return &Manager{pending: make(map[string]chan *Answer)}
}
...
func (r *Manager) Wait(ctx context.Context, requestID string, timeoutSec int, defaultValue string) (*Answer, error) {
...
func (r *Manager) Resolve(requestID string, ans *Answer) bool {
	r.mu.Lock()
...
func (r *Manager) Ask(ctx context.Context, requestID string, q *Question) (*Answer, error) {
...
func (r *Manager) Approve(ctx context.Context, sink event.Sink, sessionID string, ar *ApprovalRequest) (*Answer, error) {
